...
export const registerCatalogHandler = async (fastify, service) => {
    ...
    // --- PRODUCTS ---
    fastify.post("/api/catalog/products", async (request, reply) => {
        try {
    ...
    fastify.get("/api/catalog/products/:id", async (request, reply) => {
        try {
    ...
    fastify.patch("/api/catalog/products/:id", { preHandler: authGuard }, async (request, reply) => {
        try {
    ...
    // --- PRODUCT VARIANTS ---
    fastify.post("/api/catalog/products/:id/variants", { preHandler: authGuard }, async (request, reply) => {
        try {
    ...
    fastify.get("/api/catalog/products/:id/variants", async (request, reply) => {
        try {
    ...
    // --- CATEGORIES ---
    fastify.post("/api/catalog/categories", { preHandler: authGuard }, async (request, reply) => {
        try {
    ...
    fastify.get("/api/catalog/categories/:id", async (request, reply) => {
        try {
    ...
    fastify.patch("/api/catalog/categories/:id", { preHandler: authGuard }, async (request, reply) => {
        try {
    ...
    // --- INVENTORIES ---
    fastify.get("/api/catalog/inventories", { preHandler: authGuard }, async (request, reply) => {
        try {
    ...
    fastify.post("/api/catalog/inventories", { preHandler: authGuard }, async (request, reply) => {
        try {
    ...
    fastify.patch("/api/catalog/inventories/:id", { preHandler: authGuard }, async (request, reply) => {
        try {
