...
const deals = [
  { name: "Organic Apples (1kg)", original: "₹599", sale: "₹349", discount: "42%", emoji: "🍎" },
  { name: "Fresh Blueberries (500g)", original: "₹899", sale: "₹599", discount: "33%", emoji: "🫐" },
  { name: "Ripe Mangoes (3pcs)", original: "₹749", sale: "₹499", discount: "33%", emoji: "🥭" },
  { name: "Strawberry Pack (750g)", original: "₹699", sale: "₹449", discount: "36%", emoji: "🍓" },
  { name: "Green Grapes (1kg)", original: "₹949", sale: "₹649", discount: "32%", emoji: "🍇" },
  { name: "Orange Box (2kg)", original: "₹1099", sale: "₹749", discount: "32%", emoji: "🍊" },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {deals.map((deal, i) => (
            ...
            >
              <div
                className="w-20 h-20 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform"
